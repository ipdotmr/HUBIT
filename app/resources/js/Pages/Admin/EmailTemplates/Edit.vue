...
const form = useForm({
    ...
    subject_en: props.template.subject_en,
    body_en: props.template.body_en,
    subject_ar: props.template.subject_ar || '',
    body_ar: props.template.body_ar || '',
    subject_fr: props.template.subject_fr || '',
    body_fr: props.template.body_fr || '',
    variables: props.template.variables || [],
    is_active: props.template.is_active,
});

const submit = () => {
    form.put(route('managit.email-templates.update', props.template.id));
};
