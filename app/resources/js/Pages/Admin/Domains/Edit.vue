...
const submit = () => {
    form.put(route('managit.domains.update', props.domain.id));
};
</script>
    ...
    <WhmcsAdminLayout>
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="mb-0">Edit Domain</h3>
                <div>
                    <Link :href="route('managit.domains.show', domain.id)" class="btn btn-secondary me-2">
