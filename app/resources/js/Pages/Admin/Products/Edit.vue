...
const form = useForm({
    ...
    billing_cycle: props.product.billing_cycle,
    setup_fee: props.product.setup_fee,
    status: props.product.status
});

const submit = () => {
    form.put(route('managit.products.update', props.product.id));
};
</script>
    ...
    <WhmcsAdminLayout>
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <Link :href="route('managit.products.show', product.id)" class="btn btn-secondary me-2">
