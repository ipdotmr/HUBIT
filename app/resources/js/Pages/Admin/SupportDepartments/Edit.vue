...
const form = useForm({
    ...
    name_ar: props.department.name_ar,
    name_fr: props.department.name_fr,
    description_en: props.department.description_en || '',
    description_ar: props.department.description_ar || '',
    description_fr: props.department.description_fr || '',
...
const submit = () => {
    form.put(route('managit.support-departments.update', props.department.id));
};
</script>

<template>
    <Head :title="`Edit Department - ${department.name_en}`" />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Edit Department - {{ department.name_en }}</h4>
                    </div>
                </div>
            </div>
        </template>
