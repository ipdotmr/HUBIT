...
const form = useForm({
    title: props.networkStatus.title,
    description: props.networkStatus.description,
    status: props.networkStatus.status,
    priority: props.networkStatus.priority,
    started_at: props.networkStatus.started_at,
    resolved_at: props.networkStatus.resolved_at,
    is_resolved: props.networkStatus.is_resolved,
});

const submit = () => {
    form.put(route('managit.network-status.update', props.networkStatus.id));
};
</script>

<template>
    <Head title="Edit Network Status" />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Edit Network Status</h4>
                    </div>
                </div>
            </div>
        </template>
