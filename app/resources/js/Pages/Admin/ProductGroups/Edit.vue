...
const form = useForm({
    ...
    sort_order: props.group.sort_order,
});

const submit = () => {
    form.put(route('managit.product-groups.update', props.group.id));
};
</script>

<template>
    <Head :title="`Edit Product Group - ${group.name}`" />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Edit Product Group - {{ group.name }}</h4>
                    </div>
                </div>
            </div>
        </template>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    >
                                        ...
                                        {{ form.processing ? 'Updating...' : 'Update Product Group' }}
                                    </button>
