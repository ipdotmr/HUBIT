  ...
  >
    <div class="settings-grid">
      ...
      <div class="settings-section">
        ...
        <p class="section-description">Choose between sandbox and live mode</p>
        
        <div class="mode-selector">
          <button
            @click="form.mode = 'sandbox'"
            :class="['mode-button', { active: form.mode === 'sandbox' }]"
            type="button"
          >
            ...
            <div>
              ...
              <div class="mode-desc">Test with sandbox credentials</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div class="mode-desc">Use production credentials</div>
            </div>
          </button>
        </div>
      </div>
      ...
      <div class="settings-section">
        ...
        <p class="section-description">Your PayPal REST API credentials</p>
        ...
        <div class="form-grid">
          <FormField
            ...
            helpText="Public client identifier"
            required
      ...
      <div class="settings-section">
        ...
        <p class="section-description">Configure PayPal webhook endpoints</p>
      ...
      <div class="settings-section">
        ...
        <p class="section-description">Verify your PayPal configuration</p>
...
const form = ref({
  mode: props.settings?.paypal?.['paypal.mode'] || 'sandbox',
  client_id: props.settings?.paypal?.['paypal.client_id'] || '',
  client_secret: props.settings?.paypal?.['paypal.client_secret'] || '',
  webhook_id: props.settings?.paypal?.['paypal.webhook_id'] || '',
});
...
const webhookUrl = computed(() => {
  return `${window.location.origin}/webhooks/paypal`;
});
...
const handleSave = () => {
  ...
  const settings = [
    { key: 'paypal.mode', value: form.value.mode, type: 'string' },
    { key: 'paypal.client_id', value: form.value.client_id, type: 'string' },
    { key: 'paypal.client_secret', value: form.value.client_secret, type: 'string', is_secret: true },
    { key: 'paypal.webhook_id', value: form.value.webhook_id, type: 'string', is_secret: true },
  ];
