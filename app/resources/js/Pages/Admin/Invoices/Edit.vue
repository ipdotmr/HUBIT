...
const form = useForm({
    ...
    items: props.invoice.items.length > 0 ? props.invoice.items : [{ description: '', amount: 0 }]
});
...
const submit = () => {
    form.put(route('managit.invoices.update', props.invoice.id));
};
</script>
    ...
    <WhmcsAdminLayout>
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="mb-0">Edit Invoice #{{ invoice.id }}</h3>
                    ...
                    <form @submit.prevent="submit">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select v-model="form.status" class="form-select" :class="{ 'is-invalid': form.errors.status }" required>
